...
def form_voxel_slice_img_vectorized(
    img_h, img_w, point_cloud, num_slices=35, zmin=-2.5, zmax=1
):
    """
		Args:
		-	img_h
...
def test_form_voxel_slice_img():
    """
	"""
    point_cloud1 = np.array([[1, 1, 2], [1, 1, 6], [3, 3, 0], [3, 3, 4]])

    point_cloud2 = np.array([[1, 1, 3.9], [1, 1, 6.01], [3, 3, 1.9], [3, 3, 5.9]])
    ...
    img1_v = form_voxel_slice_img_vectorized(
        img_h, img_w, point_cloud1, num_slices, zmin, zmax
    )
    img2_v = form_voxel_slice_img_vectorized(
        img_h, img_w, point_cloud1, num_slices, zmin, zmax
    )
...
def test_form_voxel_slice_img_all_out_of_bounds():
    """
	"""
    point_cloud1 = np.array([[1, 1, -2], [1, 1, -6], [3, 3, 2.0], [3, 3, 14]])

    point_cloud2 = np.array([[1, 1, -200], [1, 1, -100], [3, 3, 2.01], [3, 3, 100]])
